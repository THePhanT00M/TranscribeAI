...
def cli():
    ...
    parser.add_argument("-ot", "--output_type", type=str, default='all', choices=['all', 'smi', 'srt', 'txt', 'vtt'])
    ...
    parser.add_argument("-d", "--device", type=str, default='cuda', choices=['cpu', 'cuda', 'mps'])
    parser.add_argument("-c", "--compute_type", type=str, default='float16', choices=['int8', 'float16'])
